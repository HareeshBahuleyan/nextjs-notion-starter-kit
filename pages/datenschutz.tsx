...
export default function Datenschutz() {
  return (
    <>
      <Head>
        <title>Datenschutzerklärung - Learn German Grammar</title>
      ...
      <div className={styles.legalContainer}>
        <div className={styles.legalContent}>
          ...
          <p>
            Telefon: 030 8145-1867<br />
            E-Mail: info[at]learngermangrammar.com
          </p>
          ...
          <p>
            Diese Website nutzt Fathom Analytics, einen datenschutzfreundlichen Webanalysedienst. 
            Fathom Analytics erfasst anonymisierte Nutzungsdaten ohne Verwendung von Cookies und ohne 
            Tracking über mehrere Websites hinweg. Es werden keine personenbezogenen Daten erfasst.
          </p>
          <p>
            Anbieter ist Conva Ventures Inc. (Fathom Analytics), Kanada. Weitere Informationen finden 
            Sie in der Datenschutzerklärung von Fathom:{' '}
          ...
          <p>
            Diese Website nutzt PostHog, eine Open-Source-Analyseplattform. PostHog ermöglicht es uns, 
            das Nutzerverhalten auf unserer Website zu analysieren und zu verstehen, wie Besucher mit 
            unseren Inhalten interagieren.
          </p>
          <p>
            PostHog erfasst Daten wie Seitenaufrufe, Klicks, Scrollverhalten und andere Interaktionen. 
            Diese Daten werden verwendet, um die Benutzererfahrung zu verbessern und unsere Website zu 
            optimieren.
          </p>
          <p>
            Anbieter ist PostHog Inc., USA. Weitere Informationen finden Sie in der Datenschutzerklärung 
            von PostHog:{' '}
          ...
          <p>
            Diese Website nutzt Vercel Analytics zur Erfassung von Leistungsdaten und Besucherstatistiken. 
            Vercel Analytics ist datenschutzfreundlich und erfasst keine personenbezogenen Daten. Es 
            werden ausschließlich aggregierte Daten erhoben.
          </p>
          <p>
            Die erfassten Daten umfassen Seitenaufrufe, Ladezeiten und allgemeine Nutzungsstatistiken, 
            jedoch ohne Tracking einzelner Nutzer über mehrere Sitzungen hinweg.
          </p>
          <p>
          ...
          <ul>
            <li><strong>Recht auf Auskunft:</strong> Sie haben das Recht, Auskunft über Ihre von uns verarbeiteten personenbezogenen Daten zu verlangen.</li>
            <li><strong>Recht auf Berichtigung:</strong> Sie haben das Recht, unverzüglich die Berichtigung unrichtiger personenbezogener Daten zu verlangen.</li>
            ...
            <li><strong>Widerspruchsrecht:</strong> Sie haben das Recht, aus Gründen, die sich aus Ihrer besonderen Situation ergeben, jederzeit gegen die Verarbeitung Ihrer Daten Widerspruch einzulegen.</li>
